...
chat_log = scrolledtext.ScrolledText(root, width=30, height=10, font='TkFixedFont', bg="#F0F0F0")
...
input_field = tk.Entry(root, bd=1, font='TkFixedFont',bg="#F0F0F0", highlightbackground="blue")
...
def send_message(event):
    ...
    if msg != '':
        ...
        # Obtém a resposta do chatbot e exibe no chat
